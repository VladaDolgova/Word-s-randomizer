...
const Words = () => {
    ...
    return (
        <div className="d-flex flex-column flex-wrap justify-content-center position-absolute w-100 h-100 align-items-center align-content-center">
            ...
            <div className="input-group mt-3 mb-2" style={{ width: '300px' }}>
            ...
            <div className="form-check form-check-inline">
                <input className="form-check-input" style={{ accentColor: 'black' }} type="checkbox" id="inlineCheckbox1" value="option1" onChange={() => setTraslation(!translation)} />
